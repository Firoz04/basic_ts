...
var LoginPage = /** @class */ (function () {
    ...
    Object.defineProperty(LoginPage.prototype, "loginBtn", {
        get: function () { return $('#login-button'); },
        enumerable: false,
        configurable: true
    });
    LoginPage.prototype.login = function (user, pass) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.username.setValue(user)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.password.setValue(pass)];
                    case 2:
                        _a.sent();
